  ...
  return (
    <div>
        ...
        <div className="about">
            ...
            <div>
                <img id="about-image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKVuqsRX__sah-RrnPxDtyrAx0dp_lFC5bkxBqL91bN1odDL4jPhsfOIdG5r-szVDdFLs&usqp=CAU" alt="student store logo"/>
            </div>
        </div>
    </div>
  )
